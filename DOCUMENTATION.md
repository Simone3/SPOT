...
- fades out for 3 seconds before flushing a state change from the completion checkbox; changing the checkbox back before the fade completes cancels the state flush and restores full opacity

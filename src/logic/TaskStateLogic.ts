...
export const loadSampleTasksIntoTaskState = (prevTaskState: TaskStateContainer): TaskStateContainer => {
	return loadTasksIntoTaskState(prevTaskState, SAMPLE_INPUT_TASKS);
};
